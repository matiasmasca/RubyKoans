...
class AboutRegularExpressions < EdgeCase::Koan
  ...
  def test_slash_w_is_a_shortcut_for_a_word_character_class
    ...
    assert_equal "variable_1", "variable_1 = 42"[/\w+/] #Word completa...
  end
  ...
  def test_a_character_class_can_be_negated
    assert_equal "the number is ", "the number is 42"[/[^0-9]+/] #La Inversa.. ^ o negacion.
  end

  def test_shortcut_character_classes_are_negated_with_capitals
    assert_equal "the number is ", "the number is 42"[/\D+/] #Negando digitos
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    ...
    assert_equal nil, "start end"[/\Aend/] #al inicio de la cadena
  end
